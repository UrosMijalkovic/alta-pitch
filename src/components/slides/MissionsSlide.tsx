      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {missionCategories.map((category, index) => (
            <motion.div
              key={category.title}
              className="glass rounded-2xl overflow-hidden group hover:border-[#52AE30]/50 transition-all duration-300"
              ...
              >
                ...
                <div className="flex items-center justify-between relative z-10">
                  ...
                  {category.progress === 100 && (
                    <span className="px-2 py-0.5 rounded-full text-xs font-medium bg-[#52AE30] text-white">
                      Complete
                    </span>
                  )}
                </div>
                ...
                {category.missions.map((mission, mIndex) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className={`text-sm leading-tight ${mission.done ? 'text-[#8A94A6]' : 'text-white'}`}>
                        {mission.step}
                      </p>
                    </div>
                    <span
