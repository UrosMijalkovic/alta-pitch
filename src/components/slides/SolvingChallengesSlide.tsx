    ...
    <div className="h-full w-full flex flex-col justify-center px-6 md:px-12 lg:px-16 py-6">
      <div className="max-w-6xl mx-auto w-full">
        ...
        >
          ...
          >
            Solving OTP&apos;s <span className="gradient-text">Specific</span> Challenges
          </h2>
        ...
        <div className="space-y-3">
          {solutionsMapping.map((item, index) => (
            <motion.div
              key={item.pain}
              className="glass rounded-xl overflow-hidden group hover:border-[#52AE30]/50 transition-all duration-300"
            ...
            >
              <div className="flex flex-col md:flex-row">
                {/* Pain point side */}
                <div className="flex-1 p-3 border-b md:border-b-0 md:border-r border-white/5 relative">
                  <div
                  ...
                  <div className="flex items-center gap-3 pl-3">
                    ...
                    <div>
                      <h3 className="text-sm font-semibold text-white">{item.pain}</h3>
                      <p className="text-xs text-[#8A94A6]">{item.painDetail}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="hidden md:flex items-center justify-center px-4">
                  ...
                  >
                    <svg className="w-8 h-8 text-[#52AE30]" fill="currentColor" viewBox="0 0 20 20">
                ...
                {/* Solution side */}
                <div className="flex-1 p-3 bg-[#52AE30]/5 relative">
                  <div className="absolute top-0 left-0 w-1 h-full bg-[#52AE30] md:hidden" />
                  <div className="flex items-center gap-3 pl-3 md:pl-0">
                    <div className="w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 bg-[#52AE30]/20 text-[#52AE30]">
                      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M5 13l4 4L19 7" />
                      </svg>
                    </div>
                    <div>
                      <h3 className="text-sm font-semibold text-white">{item.solution}</h3>
                      <p className="text-xs text-[#8A94A6]">{item.solutionDetail}</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        >
          <div className="inline-flex items-center gap-3 glass rounded-full px-6 py-3">
            ...
            <p className="text-[#8A94A6]">
              Every solution is{' '}
              <span className="text-[#52AE30] font-medium">configurable by OTP</span>
              {' '}and{' '}
              <span className="text-[#52AE30] font-medium">measurable in real-time</span>
            </p>
          </div>
        </motion.div>
      </div>
