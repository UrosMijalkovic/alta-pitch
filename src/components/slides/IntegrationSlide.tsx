  ...
  return (
    <div className="h-full w-full flex flex-col justify-center px-4 md:px-12 lg:px-16 py-4 md:py-6">
      <div className="max-w-6xl mx-auto w-full">
        ...
        <motion.div
          className="glass rounded-lg md:rounded-xl p-3 md:p-4 mb-3 md:mb-4"
          initial={{ opacity: 0, scale: 0.95 }}
          animate={{ opacity: 1, scale: 1 }}
          transition={{ delay: 0.3, duration: 0.6 }}
        >
          <div className="flex flex-col lg:flex-row items-center justify-center gap-3 md:gap-4">
            {/* OTP App */}
            <motion.div
              className="w-28 md:w-40 h-24 md:h-36 rounded-lg md:rounded-xl bg-[#52AE30]/10 border-2 border-[#52AE30]/30 flex flex-col items-center justify-center p-2 md:p-3"
            ...
            >
              <div className="flex items-center gap-1 md:gap-2">
                <div className="w-6 md:w-8 h-0.5 bg-[#52AE30]" />
                <svg className="w-3 h-3 md:w-4 md:h-4 text-[#52AE30]" fill="currentColor" viewBox="0 0 20 20">
            ...
            >
              <div className="w-10 h-10 md:w-14 md:h-14 rounded-lg md:rounded-xl bg-gradient-to-br from-[#52AE30] to-[#006837] flex items-center justify-center mb-1 md:mb-2 overflow-hidden relative">
            ...
            >
              <div className="flex items-center gap-1 md:gap-2">
                <div className="w-6 md:w-8 h-0.5 bg-[#FFB84D]" />
                <svg className="w-3 h-3 md:w-4 md:h-4 text-[#FFB84D]" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd" />
                </svg>
              </div>
            ...
            {/* OTP Backend */}
            <motion.div
              className="w-28 md:w-40 h-24 md:h-36 rounded-lg md:rounded-xl bg-[#FFB84D]/10 border-2 border-[#FFB84D]/30 flex flex-col items-center justify-center p-2 md:p-3"
              initial={{ x: 50, opacity: 0 }}
              animate={{ x: 0, opacity: 1 }}
              transition={{ delay: 0.5, duration: 0.5 }}
            >
              <div className="w-10 h-10 md:w-16 md:h-16 rounded-lg md:rounded-xl bg-[#1A222C] border-2 border-[#FFB84D]/50 flex items-center justify-center mb-1 md:mb-3">
                <svg className="w-5 h-5 md:w-8 md:h-8 text-[#FFB84D]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
