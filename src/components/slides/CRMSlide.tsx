  ...
  return (
    <div className="h-full w-full flex flex-col justify-center px-4 md:px-12 lg:px-16 py-3 md:py-8">
      <div className="max-w-6xl mx-auto w-full">
        ...
        >
          <span className="text-[#52AE30] text-[10px] md:text-sm font-medium uppercase tracking-widest mb-1 md:mb-3 block">
            Optional Add-On
          </span>
          <h2
        ...
        <div className="grid grid-cols-2 lg:grid-cols-2 gap-2 md:gap-6">
          ...
          >
            <h4 className="text-[#52AE30] text-[10px] md:text-sm font-medium uppercase tracking-wider mb-1.5 md:mb-5">
              The Feedback Loop
            </h4>
            ...
            <div className="space-y-1 md:space-y-4">
              {/* User Actions */}
              <motion.div
                className="bg-[#1A222C] rounded-md md:rounded-xl p-1.5 md:p-4 text-center"
              ...
              >
                <motion.svg
                  className="w-3 h-3 md:w-6 md:h-6 text-[#52AE30]"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                  animate={{ y: [0, 4, 0] }}
              ...
              {/* Gamification Engine */}
              <motion.div
                className="bg-gradient-to-r from-[#52AE30]/20 to-[#006837]/20 border border-[#52AE30]/40 rounded-md md:rounded-xl p-1.5 md:p-4 text-center"
                initial={{ y: 10, opacity: 0 }}
                animate={{ y: 0, opacity: 1 }}
                transition={{ delay: 0.6, duration: 0.3 }}
              >
                <p className="text-[#52AE30] font-bold text-[10px] md:text-base">Gamification</p>
              ...
              >
                <motion.svg
                  className="w-3 h-3 md:w-6 md:h-6 text-[#C5A572]"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                  animate={{ y: [0, 4, 0] }}
              ...
              >
                <p className="text-[#C5A572] font-semibold text-[10px] md:text-base">Personalized</p>
          ...
          >
            ...
            <div className="flex-1 grid grid-cols-1 gap-1 md:gap-4">
              {features.map((feature, index) => (
                <motion.div
                  key={feature.title}
                  className="bg-[#1A222C] rounded-md md:rounded-xl p-1.5 md:p-4 flex items-start gap-1.5 md:gap-3"
                  initial={{ scale: 0.9, opacity: 0 }}
                  animate={{ scale: 1, opacity: 1 }}
                  transition={{ delay: 0.5 + index * 0.08, duration: 0.3 }}
                >
                  <div className="w-1.5 h-1.5 md:w-2.5 md:h-2.5 rounded-full bg-[#52AE30] mt-1 md:mt-1.5 flex-shrink-0" />
                  <div>
        ...
        >
          <div className="inline-flex items-center gap-1.5 md:gap-2 glass rounded-full px-3 md:px-6 py-1.5 md:py-2.5">
            <svg className="w-3 h-3 md:w-5 md:h-5 text-[#52AE30]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
